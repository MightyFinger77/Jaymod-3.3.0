#ifndef BGAME_Q_SHARED_H
#define BGAME_Q_SHARED_H
...
#include <bgame/surfaceflags.h>			// shared with the q3map utility
...
typedef struct playerState_s {
	...
	int			holdable[16];  // ET-SDK 2.60: network 16-bits (signed)
...
typedef enum {
	...
	ET_BULLET_VOLUME,
	ET_ALIGNED_HIT_VOLUME,
	ET_ORIENTED_HIT_VOLUME,
