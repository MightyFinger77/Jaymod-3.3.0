...
namespace objects {
    ...
    Cvar bg_aimSpreadTurnScale ( "g_aimSpreadTurnScale", "1.0", CVAR_JAYMODINFO );
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // Development aid for drawing bullet paths.
    Cvar g_debugBullets        ( "g_debugBullets",         "0", CVAR_CHEAT, NULL );

    // Limits consecutive panzer maps and applies an equal map lockout.
    Cvar g_panzerMapLimit      ( "g_panzerMapLimit",      "0", CVAR_ARCHIVE, NULL );
    ...
    // Milliseconds subtracted from antilag reconciliation time. Zero disables it.
    Cvar g_hitmodeAntilagInterp( "g_hitmodeAntilagInterp", "0", 0, NULL );
