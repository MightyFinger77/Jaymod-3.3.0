...
class Project:
    ...
    def dump(this, mode):
        if (mode == 1):
            ...
            print 'PROJECT.authorOrig     = ' + this.authorOrig
        ...
        if (mode == 2):
            ...
            print '#define JAYMOD_authorOrig     "' + this.authorOrig + '"'
        ...
        if (mode == 3):
            ...
            print 'define(<<__authorOrig>>, <<'     + this.authorOrig          + '>>)dnl'
        ...
        if (mode == 4):
            ...
            print '<!ENTITY project:authorOrig     "' + this.authorOrig          + '">'
